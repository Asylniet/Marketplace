...
function buttonCheck() {
    if (password_check_input != null) {
        ...
        phone_input.value.length == 18 ? phone_input.parentElement.setAttribute('valid', '') : phone_input.parentElement.removeAttribute('valid');
        ...
        password_check_input.value.length == 0 ? password_check_input.parentElement.removeAttribute('valid') : errors;
    }
    ...
    if (password_input != null) {
        password_input.addEventListener('input', function() {
            if (password_check_input != null) {
                ...
                password_input.value.length > 0 ? errors[1] = true : errors[1] = false;
            }
            document.querySelector('.error').classList.remove('visible');
            buttonCheck();
        })
